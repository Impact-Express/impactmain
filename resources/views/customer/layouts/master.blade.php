    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <div class="column-sm">
                <h4>Services</h4>
                <ul class="list-group footer-links">
                    <li class="list-group-item"><a href="/services/international-shipping-destinations">Worldwide Shipping Destinations</a></li>
                    <li class="list-group-item"><a href="/services/dangerous-goods-service">Dangerous Goods Service</a></li>
                    <li class="list-group-item"><a href="/information/dry-ice-shipments">Dry Ice</a></li>
