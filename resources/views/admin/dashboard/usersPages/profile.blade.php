                                   ...
                                   <div class="post-details">
                                    <form action="{{ route('admin-edit-profile', $user->slug) }}" id="post-form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group @error('displayName') has-error @enderror">
                                            ...
                                            <input type="text" name="title" id="edit-user-displayName" class="form-text @error('title') has-error @enderror" value="{{ $user->name }}">
                                            @error('displayName')
                                        ...
                                        <div class="form-group">
                                            <button class="button-success">Update Profile</button>
                                        </div>
                                    </div>
                                </div>
